 ...
 * ```
 */
export declare const FormRadioGroup: import("../utils/types.js").Component<FormRadioGroupOptions<"div">>;
export type FormRadioGroupOptions<T extends As = "div"> = FormGroupOptions<T>;
export type FormRadioGroupProps<T extends As = "div"> = Props<FormRadioGroupOptions<T>>;
