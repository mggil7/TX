...
var _VIPX6GSMcjs = require('../__chunks/VIPX6GSM.cjs');
...
var useMenuButtonArrow = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store"]);
    const context = _6RYSMHQYcjs.useMenuContext.call(void 0, );
    store = store || context;
    props = _VIPX6GSMcjs.usePopoverDisclosureArrow.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
var MenuButtonArrow = _Z5PUIG6Acjs.createComponent.call(void 0, 
  (props) => {
