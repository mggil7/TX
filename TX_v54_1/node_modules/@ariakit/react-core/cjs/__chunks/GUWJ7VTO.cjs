...
var _HWZH54NBcjs = require('./HWZH54NB.cjs');
...
var useCompositeItem = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    ...
    const rowId = _EVNF7KMTcjs.useStoreState.call(void 0, store, (state) => {
      if (rowIdProp)
        return rowIdProp;
      if (!state)
        return;
    ...
    const baseElement = _EVNF7KMTcjs.useStoreState.call(void 0, 
      store,
    ...
    const isActiveItem = _EVNF7KMTcjs.useStoreState.call(void 0, 
      store,
      (state) => !!state && state.activeId === id
    );
    const virtualFocus = _EVNF7KMTcjs.useStoreState.call(void 0, store, "virtualFocus");
    ...
    const ariaSetSize = _EVNF7KMTcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const ariaPosInSet = _EVNF7KMTcjs.useStoreState.call(void 0, store, (state) => {
    ...
    const isTabbable = _EVNF7KMTcjs.useStoreState.call(void 0, store, (state) => {
    ...
    props = _HWZH54NBcjs.useCommand.call(void 0, props);
