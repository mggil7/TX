...
function useEventOutside({
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const onEvent = (event) => {
      ...
      if (focused && !_QK4GI6B3cjs.isElementMarked.call(void 0, target, contentElement.id))
        return;
      callListener(event);
    };
  ...
  useEventOutside(_72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {}, props), {
    ...
    listener: (event) => {
      ...
      if (!_dom.isVisible.call(void 0, previousMouseDown))
        return;
      if (!_QK4GI6B3cjs.isElementMarked.call(void 0, previousMouseDown, contentElement == null ? void 0 : contentElement.id))
        return;
