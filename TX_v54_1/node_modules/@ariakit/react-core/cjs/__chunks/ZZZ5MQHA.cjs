...
var _HSOKUBYYcjs = require('./HSOKUBYY.cjs');
...
function useDialogStoreProps(store, update, props) {
  return _HSOKUBYYcjs.useDisclosureStoreProps.call(void 0, store, update, props);
}
function useDialogStore(props = {}) {
  const [store, update] = _EVNF7KMTcjs.useStore.call(void 0, Core.createDialogStore, props);
