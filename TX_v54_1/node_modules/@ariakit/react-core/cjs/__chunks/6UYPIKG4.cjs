...
var _J37FS72Ucjs = require('./J37FS72U.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _J37FS72Ucjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
    if (itemId === id)
      return true;
    const object = getItemObject(item);
...
function useCompositeRenderer(_a) {
  ...
  store = store || context;
  const orientation = _EVNF7KMTcjs.useStoreState.call(void 0, 
    store,
  ...
  const items = _EVNF7KMTcjs.useStoreState.call(void 0, store, (state) => {
    var _a2;
    if (!state)
      return props.items;
  ...
  const activeId = _EVNF7KMTcjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _J37FS72Ucjs.useCollectionRenderer.call(void 0, _72I2GWXFcjs.__spreadProps.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices
