...
var useComposite = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      store,
      composite = true,
    ...
    const context = _H7R5D2FRcjs.useCompositeProviderContext.call(void 0, );
    store = store || context;
    ...
    props = _5WLTMVVQcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _H7R5D2FRcjs.CompositeContextProvider, { value: store, children: element }),
      [store]
    );
    const activeDescendant = store.useState((state) => {
      ...
      if (!state.virtualFocus)
        return;
      return (_a2 = _KLZID3QOcjs.getEnabledItem.call(void 0, store, state.activeId)) == null ? void 0 : _a2.id;
    });
...
var Composite = _Z5PUIG6Acjs.createComponent.call(void 0, (props) => {
