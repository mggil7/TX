...
var usePopoverDisclosureArrow = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store, placement } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store", "placement"]);
    const context = _AKOG5S2Tcjs.usePopoverContext.call(void 0, );
    store = store || context;
...
var PopoverDisclosureArrow = _Z5PUIG6Acjs.createComponent.call(void 0, (props) => {
