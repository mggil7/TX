...
var useFocusable = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, {
      focusable = true,
...
var Focusable = _Z5PUIG6Acjs.createComponent.call(void 0, (props) => {
  props = useFocusable(props);
  return _Z5PUIG6Acjs.createElement.call(void 0, "div", props);
});
