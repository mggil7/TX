...
var _232HWSNYcjs = require('./232HWSNY.cjs');
...
function useToolbarStoreProps(store, update, props) {
  return _232HWSNYcjs.useCompositeStoreProps.call(void 0, store, update, props);
}
function useToolbarStore(props = {}) {
  const [store, update] = _EVNF7KMTcjs.useStore.call(void 0, Core.createToolbarStore, props);
