...
var useComboboxItemValue = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    var _b = _a, { store, value } = _b, props = _72I2GWXFcjs.__objRest.call(void 0, _b, ["store", "value"]);
    const context = _ZBG4TGVLcjs.useComboboxScopedContext.call(void 0, );
    store = store || context;
    const itemContext = _react.useContext.call(void 0, _ZBG4TGVLcjs.ComboboxItemValueContext);
...
var ComboboxItemValue = _Z5PUIG6Acjs.createComponent.call(void 0, 
  (props) => {
