...
var _UK2DHDQUcjs = require('../__chunks/UK2DHDQU.cjs');


var _ZQZC54NScjs = require('../__chunks/ZQZC54NS.cjs');
require('../__chunks/GUWJ7VTO.cjs');
...
var useToolbarContainer = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
    ...
    store = store || context;
    props = _UK2DHDQUcjs.useCompositeContainer.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    props = _ZQZC54NScjs.useToolbarItem.call(void 0, _72I2GWXFcjs.__spreadValues.call(void 0, { store }, props));
    return props;
  }
);
