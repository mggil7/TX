...
var useFormLabel = _Z5PUIG6Acjs.createHook.call(void 0, 
  (_a) => {
...
var FormLabel = _Z5PUIG6Acjs.createMemoComponent.call(void 0, (props) => {
  const htmlProps = useFormLabel(props);
  return _Z5PUIG6Acjs.createElement.call(void 0, "label", htmlProps);
});
